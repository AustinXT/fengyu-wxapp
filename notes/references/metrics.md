...
>    2024-03-01 当期 5 天 vs 基期 4 天 → 基期偏短、同比**虚高 +25%**；
>    2028-03-01 当期 3 天 vs 基期 2 天 → **虚高 +50%**（下一次触发）；
>    2029-03-01 当期 4 天 vs 基期 5 天 → 基期偏长、同比**假下滑 −20%**。
>    ⚠️ +50% 是扫描集内的最坏值，**不是理论上界**——全历法还有 2044/2072-03-01 型的
>    「当期 2 天 vs 基期 1 天 = +100%」。且此时同比基期的起止星期也漂了，「去年同周」并非同一周。
