...
>    2024-03-01 当期 5 天 vs 基期 4 天 → **+25%**；2028-03-01 当期 3 天 vs 基期 2 天 → **+50%**
>    （下一个触发窗口）。且此时同比基期的起止星期也漂了，「去年同周」并非同一周。
...
>    306/365 天命中（首例 2025-03-01：当期 60 天 vs 基期 61 天）。最大绝对量级约 **1.7%**
>    （2024-03-01：61 天 vs 60 天）。下次触发窗口 2029。
