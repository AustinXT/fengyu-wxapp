 ...
 * **仍在割点之前**；「今年 / YTD」这类区间更会长期混入割点前月份。
 *
 * 准确的判据要写成**否定式**——设基期新客的到店观察窗为 `[entry_date, entry_date + 90 天]`
 * （见 `new-customer-funnel.ts` 的 `first_services` CTE）：
 *   - 观察窗**完全早于** 2026-07-08 → 到店恒 0，**假零基期**（当前全部受影响区间都是这一形态）
 *   - 观察窗**跨** 2026-07-08 → 到店被**低估**
 *   - 观察窗**完全晚于** 2026-07-08 → 干净
 * 即 **「观察窗未完全落在 2026-07-08 之后」就是伪影**。
 * ⚠️ 别写成「与 2026-07-08 重叠」——那只覆盖了跨线那一种，把最严重的「完全早于」漏在外面。
 *
