 ...
 *
 * 即使 prod 函数 env 被误配为 ALLOW_TEST_OPENID=true（2026-05 曾因 prod env 滞留
 * dev 值导致 staffApi 垂直提权风险），本硬闸也不会放行——不依赖运维把 env 设对。
 *
 * ⚠️ 各端独立副本（禁止抽取 cloudfunctions-shared），逻辑与 clientApi 对齐，
