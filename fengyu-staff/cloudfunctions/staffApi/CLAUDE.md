...
│   ├── customer.js   # search, calendar, detail, paidOrders, stats, listByTag, refundHistory, searchPromoterEmployees, updateProfile, updateName, updateNotes, assign, customerBalance, appointments, phoneChangeLogs
