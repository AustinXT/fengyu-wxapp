...
| customer | search, calendar, detail, paidOrders, stats, listByTag, refundHistory, searchPromoterEmployees, updateProfile, updateName, updateNotes, assign, customerBalance, appointments, phoneChangeLogs |
...
| coupon | available |
| service | create, start, complete, confirm, cancel, list, detail, counts |
