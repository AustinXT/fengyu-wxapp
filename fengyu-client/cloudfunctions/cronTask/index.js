...
exports.main = async (event) => {
  ...
  try {
    ...
    // STEP 3: 积分余额一致性校验（仅告警，不自动修 — 决策 D7）
    ...
    console.log(
      `[cronTask] STEP 3: points balance audit mismatch=${mismatchResult.mismatchCount} ` +
