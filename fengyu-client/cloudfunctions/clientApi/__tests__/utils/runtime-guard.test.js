...
describe('runtime-guard（顾客端 prod envId 硬闸）', () => {
  const PROD_ENV = 'fengyu-client-prod-d1cga6909c0ba'
  let guard
  const orig = {}
  ...
  test('生产运行时 + env=true → 硬闸强制禁用（核心安全断言）', () => {
