-- 2026-05-03 sale_order_payment_details 子表回收
-- 步骤：ADD COLUMN → 回填 → DROP TABLE
-- 顺序经手工调整：drizzle-kit 默认先 DROP 后 ADD 会丢数据，已重排为先 ADD 后 DROP。
