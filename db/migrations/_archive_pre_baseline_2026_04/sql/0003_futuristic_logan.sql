...
ALTER TABLE "public"."sale_orders" ALTER COLUMN "sale_order_type" DROP DEFAULT;--> statement-breakpoint
...
ALTER TABLE "public"."sale_orders" ALTER COLUMN "sale_order_type" SET DEFAULT '普通';