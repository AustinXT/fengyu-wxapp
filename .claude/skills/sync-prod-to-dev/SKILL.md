...
description: |
  用生产库（prod 118.178.196.26）数据覆盖开发/测试库（dev 47.113.202.7）。
...
2. 双向 IP 防误连校验（prod 必含 `118.178.196.26`、dev 必含 `47.113.202.7`，防反向灌库）
...
- 来源：生产库 `118.178.196.26:5433/fengyu_wxapp`；目标：开发库 `47.113.202.7:5433/fengyu_wxapp`
