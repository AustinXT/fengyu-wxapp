...
**基本档案编辑**: 门店模式下仅当前门店有效店长可编辑员工推荐人、顾客来源、生日、职业、婚姻状况、肌肤问题、养生偏好与临时跨门店；普通员工及管理层模式保持只读。员工推荐人必须从当前门店在职员工中按姓名/手机号模糊搜索选择，去除首尾空格后至少输入 2 个字符，不接受自由文本。临时跨门店每日 03:00 自动复位。手机号仅在顶部档案卡展示，不在基本档案中重复出现。
