 ...
 *
 * **三条已登记的既有偏差，都不在 #283 范围**（#283 只修 week/month 的 previous）：
 *
 ...
 *             2024-03-01 当期 5 天 vs 基期 4 天 → **+25%**
 *             2028-03-01 当期 3 天 vs 基期 2 天 → **+50%**（下一个触发窗口）
 ...
 *           基期含 2/29 而当期没有，基期**长 1 天**；当年闰年则反向短 1 天。
 *           2025 与 2029 各 306/365 天命中（首例 2025-03-01：当期 60 天 vs 基期 61 天）。
 *           最大绝对量级约 **1.7%**（2024-03-01：61 天 vs 60 天）。下次触发窗口 2029。
 *
