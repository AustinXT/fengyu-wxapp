...
const PRODUCT_SKUS = [
  { skuId: 'sku-001-01', categoryId: 'cat-hr-01', productType: '疗程卡' as const, specName: '蜜语水润嫩肤护理 单次体验', price: '299.00', specialPrice: '259.00', sessionCount: 1, unit: '次', sortOrder: 1, serviceFee: '30.00', isShengmei: true, marketScope: null, isEnabled: true },
  { skuId: 'sku-001-02', categoryId: 'cat-hr-01', productType: '疗程卡' as const, specName: '蜜语水润嫩肤护理 10次卡', price: '1999.00', specialPrice: '1800.00', sessionCount: 10, unit: '次', sortOrder: 2, serviceFee: '50.00', isShengmei: true, marketScope: null, isEnabled: true },
  { skuId: 'sku-001-03', categoryId: 'cat-hr-01', productType: '疗程卡' as const, specName: '蜜语水润嫩肤护理 20次卡', price: '3599.00', specialPrice: '3200.00', sessionCount: 20, unit: '次', sortOrder: 3, serviceFee: '50.00', isShengmei: true, marketScope: null, isEnabled: true },
  { skuId: 'sku-002-01', categoryId: 'cat-hr-01', productType: '疗程卡' as const, specName: '科颜美逆龄焕肤 单次', price: '599.00', specialPrice: '499.00', sessionCount: 1, unit: '次', sortOrder: 1, serviceFee: '50.00', isShengmei: true, marketScope: null, isEnabled: true },
  { skuId: 'sku-002-02', categoryId: 'cat-hr-01', productType: '疗程卡' as const, specName: '科颜美逆龄焕肤 6次卡', price: '2999.00', specialPrice: '2680.00', sessionCount: 6, unit: '次', sortOrder: 2, serviceFee: '60.00', isShengmei: true, marketScope: null, isEnabled: true },
  { skuId: 'sku-003-01', categoryId: 'cat-hr-02', productType: '疗程卡' as const, specName: '经络疏通养生护理 60分钟', price: '388.00', specialPrice: null, sessionCount: 1, unit: '次', sortOrder: 1, serviceFee: '40.00', isShengmei: false, marketScope: null, isEnabled: true },
  { skuId: 'sku-003-02', categoryId: 'cat-hr-02', productType: '疗程卡' as const, specName: '经络疏通养生护理 10次卡', price: '2880.00', specialPrice: '2580.00', sessionCount: 10, unit: '次', sortOrder: 2, serviceFee: '40.00', isShengmei: false, marketScope: null, isEnabled: true },
  { skuId: 'sku-004-01', categoryId: 'cat-hl-01', productType: '疗程卡' as const, specName: '新客体验 面部深层清洁', price: '0.00', specialPrice: null, sessionCount: 1, unit: '次', sortOrder: 1, serviceFee: '20.00', isShengmei: null, marketScope: null, isEnabled: true },
  { skuId: 'sku-004-02', categoryId: 'cat-hl-01', productType: '疗程卡' as const, specName: '新客体验 基础面部护理', price: '0.00', specialPrice: null, sessionCount: 1, unit: '次', sortOrder: 2, serviceFee: '20.00', isShengmei: null, marketScope: null, isEnabled: true },
  { skuId: 'sku-004-03', categoryId: 'cat-hl-01', productType: '疗程卡' as const, specName: '新客体验 肩颈放松', price: '0.00', specialPrice: null, sessionCount: 1, unit: '次', sortOrder: 3, serviceFee: '15.00', isShengmei: null, marketScope: null, isEnabled: true },
  { skuId: 'sku-005-01', categoryId: 'cat-jj-01', productType: '家居产品' as const, specName: '凤御玻尿酸精华液 30ml', price: '268.00', specialPrice: '228.00', sessionCount: null, unit: '盒', sortOrder: 1, serviceFee: '0', isShengmei: null, marketScope: null, isEnabled: true },
  { skuId: 'sku-005-02', categoryId: 'cat-jj-01', productType: '家居产品' as const, specName: '凤御玻尿酸精华液 60ml', price: '468.00', specialPrice: '398.00', sessionCount: null, unit: '盒', sortOrder: 2, serviceFee: '0', isShengmei: null, marketScope: null, isEnabled: true },
  { skuId: 'sku-006-01', categoryId: 'cat-jj-02', productType: '家居产品' as const, specName: '艾草精油礼盒 标准礼盒', price: '198.00', specialPrice: '168.00', sessionCount: null, unit: '盒', sortOrder: 1, serviceFee: '0', isShengmei: null, marketScope: null, isEnabled: true },
  { skuId: 'sku-007-01', categoryId: 'cat-cz-01', productType: '家居产品' as const, specName: '金卡充值卡 5000', price: '5000.00', specialPrice: null, sessionCount: null, unit: '盒', sortOrder: 1, serviceFee: '0', isShengmei: null, marketScope: null, isEnabled: true },
  { skuId: 'sku-008-01', categoryId: 'cat-hr-03', productType: '疗程卡' as const, specName: '光子嫩肤仪器护理 单次', price: '880.00', specialPrice: '780.00', sessionCount: 1, unit: '次', sortOrder: 1, serviceFee: '80.00', isShengmei: true, marketScope: null, isEnabled: true },
  { skuId: 'sku-008-02', categoryId: 'cat-hr-03', productType: '疗程卡' as const, specName: '光子嫩肤仪器护理 5次卡', price: '3880.00', specialPrice: '3500.00', sessionCount: 5, unit: '次', sortOrder: 2, serviceFee: '80.00', isShengmei: true, marketScope: null, isEnabled: true },
]
...
const COMMISSION_RATES = [
  ...
  { orgId: '6707cc8b88579108', orderType: '服务单', roleType: '美容师', salesCategory: '自销自耗', amountTierMin: '0.00', amountTierMax: null, commissionRate: '0.1200', priceThreshold: '100.00' },
  { orgId: '6707cc8b88579108', orderType: '服务单', roleType: '养生师', salesCategory: '自销自耗', amountTierMin: '0.00', amountTierMax: null, commissionRate: '0.1200', priceThreshold: '100.00' },
...
const OPERATION_LOGS = [
  ...
  { operatorEmployeeId: 'FY-260201-0006', operatorName: '孙浩', operatorRole: 'manager', orgNodeId: 'org-store-jj01', orgNodeName: '九江旗舰店', action: 'order.confirmOffline', targetType: 'sale_order', targetId: 'FY-XSD-WX-260311-0002', detail: { previousStatus: '待支付', newStatus: '已支付' }, source: 'staffApi', createdAt: new Date('2026-03-11T14:10:00Z') },
