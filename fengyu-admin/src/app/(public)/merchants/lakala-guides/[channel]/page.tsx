...
const guides = {
  wechat: {
    title: "微信商户实名认证指南",
    description: "请使用营业执照对应法人本人微信账号/身份完成认证。",
  ...
  alipay: {
    title: "支付宝认证商户实名认证指南",
    description: "请使用营业执照对应法人本人支付宝账号/身份完成认证。",
      ...
      <div className="mx-auto max-w-5xl space-y-5">
        ...
        <Card className="border-[#D9E8DF] bg-[#F6FBF8]">
          <CardContent className="flex items-start gap-3 p-4">
            <ShieldCheck className="mt-0.5 size-5 text-[#287342]" />
            <div>
              <p className="font-medium text-[#287342]">请使用营业执照对应法人本人账号/身份完成认证。</p>
              <p className="mt-1 text-sm text-[#5E7A68]">{guide.description}完成后回到入网申请详情，点击“我已完成认证，关联收款商户”。</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">图文步骤</CardTitle>
          </CardHeader>
