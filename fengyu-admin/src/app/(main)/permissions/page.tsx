...
import { MOCK_PERMISSION_ROLES, MOCK_EMPLOYEES } from "@/lib/mock-data"
...
export default function PermissionsPage() {
  ...
  const activeRoles = MOCK_PERMISSION_ROLES.filter((r) => !r.isVoid)
  ...
  const filteredEmployees = useMemo(() => {
    const active = MOCK_EMPLOYEES.filter((e) => !e.isResigned)
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {filteredEmployees.map((emp) => {
                      const roles = activeRoles.filter((r) => r.employeeId === emp.employeeId)
                      return (
        ...
        <div className="space-y-4 mt-4">
          <div>
            ...
            >
              ...
              {MOCK_EMPLOYEES.filter((e) => !e.isResigned).map((e) => (
