...
export default function AppointmentsPage() {
  const pendingAppts = MOCK_APPOINTMENTS.filter((a) => a.status === "待确认")
  const confirmedAppts = MOCK_APPOINTMENTS.filter((a) => a.status === "已确认")
  const todayAppts = MOCK_APPOINTMENTS.filter((a) => isToday(a.appointmentTime))
  const allAppts = MOCK_APPOINTMENTS
