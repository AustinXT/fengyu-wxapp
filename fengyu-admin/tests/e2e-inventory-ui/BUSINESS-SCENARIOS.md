...
| 7 | → 品项公司发货（#336：先选收货市场，直接引用**市场报货单**，不经采购单；正常量以报货行未发量封顶，赠送行另选批次不封顶，§5.2） | **页面不展示单价与货款**（§5.3/§10.4）；顶部显示「还有 N 件未发」 | 血缘 `市场报货发货` / `市场报货赠送发货` 直连报货行；赠品行 `amount = 0`、独立批号；市场收货后赠送批次市场价与成本全 0；`doc_type='品项公司发货'`、状态「待收货」 |
